...
class User_Cancellation_Procedure_Complete extends ComponentBase {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    document.title =
      Const.TITLE_MYPAGE_USER_CANCELLATION_PROCEDURE + '申し込み完了'
  }
            ...
            <main className="t-main">
              <div className="t-container">
                <div className="t-inner">
                  <h1 className="a-h1">解約申し込みが完了しました</h1>
                  <div className="m-form">
                    <h2 className="a-h2">解約の申し込みが完了しました</h2>
...
export default connect(mapStateToProps)(User_Cancellation_Procedure_Complete)
