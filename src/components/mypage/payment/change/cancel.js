...
class Payment_Cancel extends ComponentBase {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    this.goTop()
    document.title = Const.TITLE_MYPAGE_PAYMENT_CANCEL
  }
              ...
              <div className="t-container">
                <div className="t-inner">
                  <ol className="m-breadcrumb">
                    ...
                    <li className="m-breadcrumb_item">
                      {Const.TITLE_MYPAGE_PAYMENT_CANCEL}
                    </li>
                  </ol>
                  <h1 className="a-h1">{Const.TITLE_MYPAGE_PAYMENT_CANCEL}</h1>
                  <div className="m-form">
                    <h2 className="a-h2">
                      お支払いのクレジットカードの変更申し込みをキャンセルしました
                    </h2>
...
export default connect(mapStateToProps)(Payment_Cancel)
