...
class Plan_change_complete extends ComponentBase {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    document.title = Const.TITLE_MYPAGE_PLAN_CHANGE_COMPLETE
  }
            ...
            <main className="t-main">
              <div className="t-container">
                <div className="t-inner">
                  ...
                  <h1 className="a-h1">プラン変更申込み取消完了</h1>
...
export default connect(mapStateToProps)(Plan_change_complete)
