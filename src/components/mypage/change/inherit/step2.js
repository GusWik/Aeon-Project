...
class Change_Inherit_Step2 extends ComponentBase {
  constructor(props) {
    super(props)
  ...
  goNextDisplay(e, url, params) {
    ...
    if (url === '/mypage/change/inherit/confirm') {
      const params = {
  ...
  async handleSubmitSend() {
    if (this.state.applyNumber) {
      ...
      if (update && update.result === 'OK') {
        this.goNextDisplay(null, '/mypage/change/inherit/confirm')
      }
    }
  }
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        if (this.validateAllForm()) {
                          /*  this.goNextDisplay(e, '/mypage/change/inherit/confirm') */
...
export default connect(mapStateToProps)(Change_Inherit_Step2)
