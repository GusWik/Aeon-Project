...
import { wareki } from '../../../../actions/Methods'
...
class Change_Inherit extends ComponentBase {
  constructor(props) {
    super(props)
  ...
  goNextDisplay(e, url, params) {
    ...
    } else if (url === '/mypage/change/inherit/step2') {
      const params = {
  ...
  async handleSubmit() {
    if (this.state.applyNumber) {
      ...
      if (update && update.result === 'OK') {
        this.goNextDisplay(null, '/mypage/change/inherit/step2')
      }
    }
  }
        ...
        <div className="t-wrapper">
          ...
          <main className="t-main">
            <div className="ui container">
              <h1 className="headTitle">名義変更(承継)</h1>
...
export default connect(mapStateToProps)(Change_Inherit)
