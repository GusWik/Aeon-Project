...
class Forgot_Complete extends ComponentBase {
  constructor(props) {
    super(props)
    this.state = {}
  }
  ...
  componentDidMount() {
    ...
    document.title = Const.TITLE_FORGOT_COMPLETE
  }
...
export default connect(mapStateToProps)(Forgot_Complete)
